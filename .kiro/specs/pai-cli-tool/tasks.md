...
- [x] 2. Implement Configuration Manager
  ...
  - [x]* 2.2 Write property test for config path resolution priority
    - **Property 7: Config Path Resolution Priority**
    - **Validates: Requirements 3.4**
  
  - [x]* 2.3 Write property test for schema version invariant
    - **Property 8: Config Schema Version Invariant**
    - **Validates: Requirements 3.5**
  
  - [x]* 2.4 Write property test for config persistence round-trip
...
- [x] 4. Implement Session Manager
  ...
  - [x]* 4.2 Write property test for JSONL format correctness
    - **Property 13: Session File JSONL Format**
    - **Validates: Requirements 6.3, 6.4**
  
  - [x]* 4.3 Write property test for multimodal content round-trip
    - **Property 15: Multimodal Content Round-Trip**
    - **Validates: Requirements 6.8, 11.5**
  
  - [x]* 4.4 Write property test for malformed session error handling
...
- [x] 6. Implement bash_exec tool
  ...
  - [x]* 6.2 Write property test for bash feature support
    - **Property 17: Bash Feature Support**
    - **Validates: Requirements 9.3**
  
  - [x]* 6.3 Write property test for command result structure
...
- [x] 10. Implement Output Formatter
  ...
  - [x]* 10.2 Write property test for JSON output format validity
    - **Property 11: JSON Output Format Validity**
    - **Validates: Requirements 5.5**
  
  - [x]* 10.3 Write property test for model output routing invariant
    - **Property 12: Model Output Routing Invariant**
    - **Validates: Requirements 5.7, 13.1, 13.2, 13.6**
  
  - [x]* 10.4 Write property test for log file timestamps
    - **Property 20: Log File Timestamp Presence**
    - **Validates: Requirements 12.2**
  
  - [x]* 10.5 Write property test for log file message distinction
...
- [x] 17. Final checkpoint and integration testing
  ...
  - [x] 17.3 Manual testing and validation
